...
industry: banking
seniority: architect
logo: https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSr8SiEb7MyG3xcucRsSu-kLItOVBpUa03hKQ&s

tags: [banking, finance, vehicle-financing, mobile, devops, ci-cd, java, spring-boot, spring-batch, spring-data, jenkins, docker, aws, ec2, rds, s3, elastic-beanstalk, android, ios, spring-config-server]
topics: [architecture, devops-cloud, security]
---
