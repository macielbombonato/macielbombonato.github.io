...
industry: banking
seniority: architect
tags: [architecture, banking, finance, vehicle-financing, mobile, devops, ci-cd, security]
topics: [architecture, devops-cloud, security]
technologies: [java, spring-boot, spring-batch, spring-data, jenkins, docker, aws, ec2, rds, s3, elastic-beanstalk, android, ios, spring-config-server]
---
