...
description: Como usar Git LFS (Large File Storage) para versionar arquivos com mais de 100 MB que não passam no limite padrão do GitHub.
logo: https://git-lfs.com/images/graphic.gif

tags: [git, lfs, vcs, github, large-files]
